...
public class Quiz5 extends Activity {
    ...
    private static final String[] Q1 = {
            "What is the name of hero in this book?","Rylai","Lina","Strygwyr","Lyralei"
    };
    private static final String[] Q2 = {
            "How much health of the enemi left to active Thirst?","10%","15%","20%","25%"
    };
    private static final String[] Q3 = {
            "What is the name of his ultimate skill?","Thirst","Rupture","Bloodrage","Blood Rite"
    };
